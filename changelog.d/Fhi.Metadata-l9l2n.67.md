...
- **The variabelutforsker's filter panel opens on Kilde alone, with a search box in it, and the
  ...
  of sight stays ticked and keeps narrowing the list, and emptying the box brings it back with its
  tick on. Inside that facet the kildetype headings are disclosures of their own, closed, each
