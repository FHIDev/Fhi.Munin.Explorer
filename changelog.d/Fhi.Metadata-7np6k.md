...
- **A link to a section of an open kilde or variable can be copied out of the address bar again.**
  ...
  presses through to a different kilde, datasamling, search or sort. Back returns to the section,
  because a navigation arrives with an address of its own whose fragment is honoured in its turn.
