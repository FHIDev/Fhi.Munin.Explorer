...
- **A link to a section of an open kilde or variable can be copied out of the address bar again.**
  ...
  fragment for as long as the view it names is the one on screen, and drop it for good at the
  first different kilde, datasamling, search or sort. Links the explorers build are unaffected and
