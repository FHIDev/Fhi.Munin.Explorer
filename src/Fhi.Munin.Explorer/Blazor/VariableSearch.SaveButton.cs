...
public partial class VariableSearch
{
    ...
    private RenderFragment RowSaveButton(VariableSummary v) => builder =>
    {
        ...
        // variant: this is drawn once per row, and 25 filled ones read as 25 primary actions
        // competing with the names being scanned. (Fhi.Metadata-35w0p.64, reversing Fhi.Metadata-q7i5e)
