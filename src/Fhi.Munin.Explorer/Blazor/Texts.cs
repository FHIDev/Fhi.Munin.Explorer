...
internal sealed record Texts(
    ...
    string SharedListNameRequired,
    string SharedListNameTooLong,
    string SharedListNameTaken,
    ...
    string SignInForVariableLists)
{
    ...
    private static readonly Texts No = new(
        ...
        SharedListNameRequired: "Skriv et navn på listen.",
        SharedListNameTooLong: "Navnet kan være høyst 200 tegn.",
        SharedListNameTaken: "Du har allerede en liste med dette navnet. Velg et annet navn.",
    ...
    private static readonly Texts En = new(
        ...
        ShareListEmpty: "The list is empty",
        ...
        SharedListNameRequired: "Enter a name for the list.",
        SharedListNameTooLong: "The name can be at most 200 characters.",
        SharedListNameTaken: "You already have a list with this name. Choose another name.",
        CopyList: "Copy list",
