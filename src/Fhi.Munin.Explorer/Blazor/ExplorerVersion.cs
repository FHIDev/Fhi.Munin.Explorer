...
/// </summary>
/// <remarks>
/// Read off the assembly rather than written down: this package has no endpoint, and its one static
/// web asset is a module a host need not serve, so the DOM is the only place a deployed version can
/// be read from — and a literal that drifts is worse than the silence it replaces. (Fhi.Metadata-sqbei)
/// </remarks>
